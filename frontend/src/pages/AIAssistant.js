...
const AIAssistant = () => {
    ...
    const handleQuery = async (e) => {
        ...
        try {
            const res = await aiService.getSummary(query);
                    ...
                    <Row className="mb-3">
                        <Col md={4}>
                            <Form.Group>
                                ...
                                <Form.Select name="scope" disabled={loading}>
                        ...
                        <Col md={4}>
                            <Form.Group>
                                ...
                                <Form.Control name="location" type="text" disabled={loading} placeholder="e.g., BLR" />
                            </Form.Group>
                        </Col>
